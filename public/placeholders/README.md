...
| --- | --- | --- |
| `hero-formulation.jpg` | Hero main collage | Portrait (~4:5) |
| `hero-ingredient-closeup.jpg` | Hero circle inset | Square (circle-cropped) |
| `format-drink-powders.jpg` | Formats card 1 | Landscape (~3:2) |
| `format-functional-coffee.jpg` | Formats card 2 | Landscape (~3:2) |
| `format-wellness-chocolate.jpg` | Formats card 3 | Landscape (~3:2) |
| `format-sachets.jpg` | Formats card 4 | Landscape (~3:2) |
| `format-jars-pouches.jpg` | Formats card 5 | Landscape (~3:2) |
| `format-raw-ingredients.jpg` | Formats card 6 | Landscape (~3:2) |
| `custom-dev-session.jpg` | Custom development | Square-ish |
